...
// global 정의
declare global {
  // 사용 혹은 정의 기능: typeof import(모듈)[내부의 키]
...
// for vue template auto import: 뷰 template가 자동 import
import { UnwrapRef } from 'vue'
// runtime-core 정의
declare module '@vue/runtime-core' {
  // 구성 요소 인스턴스에 어떤 방식으로든 추가된 사용자 지정 속성이며 Vue I18n에 대한 이 구성 요소 사용자 지정 속성을 통해 액세스할 수 있습니다.
